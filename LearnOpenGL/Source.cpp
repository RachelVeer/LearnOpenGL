...
int main()
{
	...
	for (unsigned int i = 0; i < amount; ++i) {
		...
		float y = displacement * 0.4f; // keep height of the field smaller compared to width
		displacement = (rand() % (int)(2 * offset * 100)) / 100.0f - offset;
	...
	// set transformation matrices as an instance vertex attributw (with divisor 1)
